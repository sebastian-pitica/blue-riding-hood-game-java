...
/*! \class Bear1
    \brief Implementează entitatea urs1.
...
public class Bear1 extends EnemieEntity {
    ...
    /*! \fn  public Bear1(int entityMatrixX, int entityMatrixY)
           \brief Constructorul clasei Bear1.
    ...
    */
    private void InitAnimation() {
        up = new Animation(speed, Assets.bear1Up);
        down = new Animation(speed, Assets.bear1Down);
        left = new Animation(speed, Assets.bear1Left);
        right = new Animation(speed, Assets.bear1Right);
    }

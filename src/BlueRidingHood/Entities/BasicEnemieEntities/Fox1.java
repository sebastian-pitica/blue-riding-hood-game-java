...
/*! \class Fox1
    \brief Implementează entitatea vulpe1.
...
public class Fox1 extends EnemieEntity {
    ...
    /*! \fn  public Fox1(int entityMatrixX, int entityMatrixY)
   ...
   */
    private void InitAnimation() {
        up = new Animation(speed, Assets.fox1Up);
        down = new Animation(speed, Assets.fox1Down);
        left = new Animation(speed, Assets.fox1Left);
        right = new Animation(speed, Assets.fox1Right);
    }
